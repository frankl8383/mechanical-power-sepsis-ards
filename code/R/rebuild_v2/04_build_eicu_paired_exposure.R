...
# rebuild_v2 Phase 1D: outcome-blind 0-6 h eICU paired ventilator tuples.
...
script_path <- if (length(file_arg)) {
  ...
  normalizePath(
    "code/R/rebuild_v2/04_build_eicu_paired_exposure.R",
    mustWork = TRUE
  )
}
...
run_transformed_v1_exposure("eicu")
